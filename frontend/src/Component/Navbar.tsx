...
export const Navbar = () => {
  ...
  useEffect(() => {
    ...
    const cartCounts = cart.reduce(
      (acc: number, item: CartProductType) => acc + item.cartQuantity,
      0
    );
          ...
          {currentUser ? (
            currentUser === "user" ? (
              <>
                ...
                <Link to="/">
                  <li className="p-[10px] hover:bg-[orange] " onClick={logOut}>
                    {" "}
                    Logout{" "}
                  </li>
                </Link>{" "}
              ...
              <>
                ...
                <Link to="/">
                  <li onClick={logOut} className="p-[10px] hover:bg-[orange] ">
                    {" "}
                    Logout{" "}
                  </li>
                </Link>
